...
@endif
  ...
  <div class="jumbotron jumbotron-fluid" style="margin-left: 0px; overflow: hidden; height: 600px;">
    <div class="img-container">
      ...
      <div class="overlay">
      <p style="font-family: Quicksand, sans-serif; font-weight: 300;">WONDERLAND </p>
      
      </div>
      <a href ="/two"> <img class="logo" src="{{ asset('images/logo.png') }}" alt="logo"> </a>
      
    </div>
    </div>
  <div class="fill-div ">
    <a href="{{ route('r.create') }}" class="btn btn-lg btn-success">Order</a>
    <div>
      &nbsp;
    </div>
</div>

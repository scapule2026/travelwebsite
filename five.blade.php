...
@endif
  ...
  <div class="jumbotron jumbotron-fluid" style="margin-left: 0px; overflow: hidden; height: 600px;">
    <div class="img-container">
      <img src="{{ asset('images/honami.PNG') }}" alt="wonderland1" class="img2">
      <div class="overlay">
        <p style="font-family: Quicksand, sans-serif; font-weight: 300;">&nbsp;&nbsp;HONAMI&nbsp;&nbsp;</p>
      </div>
      <a href ="/six">   <img class="logo" src="{{ asset('images/logo.png') }}" alt="logo"> </a>
    </div>
    </div>
  <div class="fill-div ">
    <div>
